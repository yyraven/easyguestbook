// EasyGuestBook by yyraven: a serverless, Google Forms-powered guestbook built for static blogs such as Quarto.
// Project repo: https://github.com/yyraven/easyguestbook
// See the full tutorial on my blog: https://yyraven.github.io/project/260729_tool_easyguestbook/
// Released under the MIT license.

document.addEventListener('DOMContentLoaded', function() {

    // ==========================================
    // CONFIGURATION: Replace these with your own Google IDs.
    // ==========================================
    const GOOGLE_FORM_ID = "PLACEHOLDER_FORM_ID_abcdefg"; // replace with your Google Form ID
    const GOOGLE_SHEET_ID = "PLACEHOLDER_SHEET_ID_hijklmn"; // replace with your Google Sheet ID
    const ENTRY_NAME = "entry.placeholder123"; // replace with your entry ID for nickname
    const ENTRY_MESSAGE = "entry.placeholder456"; // replace with your entry ID for message
    const ENTRY_WEBSITE = "entry.placeholder789"; // replace with your entry ID for homepage/website
    // ==========================================
